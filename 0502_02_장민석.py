'''
    ...
    설명란 : 사용자로부터 시작 값과 끝 값을 입력 받아 두 수 사이의
    ...
    [문제분석]
        ...
        num1 > num2 ??
                ...
                => 3) 두 변수의 값을 교환한다
                => 4) 사용자에게 첫번쨰 값을 작은 값, 두번째 값은 큰 값을 입력하라고 가이드를 준다
                
    [알고리즘]
        1. 두 정수를 입력받는다.
        2. 만약 num1 < num2 면
            2-1. num1부터 num2까지 1씩 증가하면서
                2-1-1. 합계를 계산한다.
                2-1-2. 수가 짝수이면
                    2-1-1-1. 짝수의 합계를 계싼한다
                2-1-3. 아니면
